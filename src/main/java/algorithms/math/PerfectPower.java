 ...
 *
 * @author nujovich
 * @see <a href="https://en.wikipedia.org/wiki/Perfect_power"></a>
 */
public class PerfectPower {

  /**
   * @param n int, natural number
   * @return an array where the first element is the root and the second element is the exponent. If
   * n has more than one tuple, the algorithm returns only the first one found.
   */
